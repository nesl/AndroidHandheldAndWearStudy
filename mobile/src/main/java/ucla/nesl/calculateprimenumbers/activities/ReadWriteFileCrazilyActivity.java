 ...
 */
public class ReadWriteFileCrazilyActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(ReadWriteFileCrazilyActivity.this, ReadWriteFileCrazilyService.class);
        startService(intent);
    }
